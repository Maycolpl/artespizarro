...
<html class="no-js" lang="">
    ...
    <meta charset="utf-8">
		...
		<link rel="shortcut icon" type="image/x-icon" href="assets/img/products/<?= $nameFolder ?>/<?= $newNameMeta ?>">
    ...
    <main>
        ...
        <section class="hero_overly pd_sub">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pd_sub_sliders swiper ">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pd_sub_text">
                            <h1 class="sec_title"> <?= $nameProduct ?></h1>
                            <p> 
                                <?= $descriptionProduct ?>
                            </p>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="detels_pd">
                            ...
                            <ul>
                                <li><p>Artista</p><span>|</span> <p>Benajmín Pizarro</p></li>
                                <li><p>Material</p><span>|</span> <p><?= $material ?></p></li>
                                <li><p>Dimensiones</p><span>|</span> <p><?= $dimensions ?></p></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="contact_form">
                            <h1 class="sec_title">Solicitar más información</h1>
                            <p>Solicita información para pedidos al por mayor, reporta un problema o solicita la ayuda que necesites.</p>
                            <form action="">
                                <div class="thr_input">
                                    <input type="text" class="name_in" placeholder="Nombres y Apellidos">
                                    <input type="text" id="mobile_codee" >
                                    <input type="text" class="numbar_in" placeholder="Celular">
                                </div>
                                <input type="text" class="corr_e" placeholder="Correo Electrónico">
                                <textarea name="" placeholder="Qué información necesitas..."></textarea>
...
var input = document.querySelector("#mobile_codee");
