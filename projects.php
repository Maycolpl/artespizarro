...
<html class="no-js" lang="">
    ...
    <body>       
                        ...
                        <div class="menu-area">
                            <nav>
                                <ul id="nav">
                                    ...
                                    <li><a href="projects.php" class="active">Proyectos </a></li> 
                                    <li>
        ...
        <!-- main START -->
        <main>        
            <section class="proy_hero hero_overly">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <div class="proy_hero_imgs">
                                <i>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <div class="proto_title ">
                                <h1 class="sec_title">Algunos de nuestros Proyectos</h1>
                                <p>Aquí podrás comprender porque cada cliente
                                    de Artes Pizarro confía en nosotros</p>
                            </div>
                        </div>
                    </div>                    
                    <div class="row">
                    <?php
                        include "dashboard/script/list-project.php"
                    ?>
                    </div>                    
                </div>
                <!-- ******************* -->
